Code to reproduce the results from the paper **Data-Driven Law Firm Rankings to Reduce Information Asymmetry in Legal Disputes** ([preprint available](http://arxiv.org/abs/2408.16863)).
...
* "routines.py" lists routines used to convert raw data into pairwise interactions. The cases_df.csv.gz added to this repo contains only a subset of the data for testing purposes. Our full source data will be made public upon publication.
